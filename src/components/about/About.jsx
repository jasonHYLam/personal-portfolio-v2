    ...
    <>
      <section ref={ref}>
        ...
        <p>
          ...
          becoming comfortable with previously unfamiliar technologies. After
          predominantly using JavaScript for backend development, I took the
          opportunity to learn C# .NET to build my educational web app.
        </p>
      </section>
    </>
  );
